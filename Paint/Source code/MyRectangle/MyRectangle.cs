...
namespace Rectangle_
{
    public class MyRectangle : IShape
    {
        ...
        public object Clone()
        {
            MyRectangle clonedShape = (MyRectangle)MemberwiseClone();
        ...
        public Canvas Convert()
        {
            ...
            frameCanvas.HorizontalAlignment = HorizontalAlignment.Center;
            frameCanvas.VerticalAlignment = VerticalAlignment.Center;
